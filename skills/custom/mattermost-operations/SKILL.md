...
- P3: Clarify 并发守护（2026-06-08 修复旧 bug：Python heredoc 中 `\\n` 为字面量而非换行符，导致 patch 从未 apply 成功，始终静默 SKIP）
...
**最近一次完整审计**：[references/hermes-v2026.6.5-plugin-audit.md](references/hermes-v2026.6.5-plugin-audit.md)（2026-06-08，v2026.6.5）
